...
# Import your postgres get_sql_database function here
from infrastructure.postgres_connection import get_sql_database  # updated import
    ...
    def _ingest_to_db(self, df: pd.DataFrame, table_name: str) -> None:
        ...
        try:
            df.to_sql(
                    ...
                    if_exists='replace', 
                    index=False,
                    schema='my_schema',  # <-- specify your schema here
                    method='multi',
                    chunksize=5000
                )
